...
public class CollapsiblePanel extends JPanel implements ActionListener {
    ...
    /**
     * The top panel: contains the buttons displayed on the top of the CollapsiblePanel
     */
    private JPanel topPanel = new JPanel(new GridLayout(1, 1))

    /**
     * The bottom panel: contains the buttons displayed on the bottom of the CollapsiblePanel
     */
    ...
    /**
     * Creates a new CollapsiblePanel after which you should make repeated calls to
     * addBar() for each bar
     */
    ...
    /**
     * Adds the specified component to the CollapsiblePanel and sets the bar's name
     *
    ...
    /**
     * Removes the specified bar from the CollapsiblePanel
     *
    ...
    public static JPanel getDummyPanel(String name) {
        ...
        chkl.setListData(['One', 'Two', 'Three'] as Object[])
        panel.add(chkl)
        return panel
    }
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("CollapsiblePanel Test")
        CollapsiblePanel outlookBar = new CollapsiblePanel()
        ...
        frame.setLocation((int) d.width / 2 - 400, (int) d.height / 2 - 300)
